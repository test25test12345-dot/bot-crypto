...
exports.RaydiumAmmParser = void 0;
const web3_js_1 = require("@solana/web3.js");
const anchor_1 = require("@project-serum/anchor");
const buffer_layout_1 = require("@solana/buffer-layout");
const buffer_layout_utils_1 = require("@solana/buffer-layout-utils");
const borsh_1 = require("borsh");
const RaydiumInitializeArgsLayout = (0, buffer_layout_1.struct)([
    (0, buffer_layout_1.u8)("nonce"),
    (0, buffer_layout_utils_1.u64)("openTime"),
]);
const RaydiumInitialize2ArgsLayout = (0, buffer_layout_1.struct)([
    (0, buffer_layout_1.u8)("nonce"),
    (0, buffer_layout_utils_1.u64)("openTime"),
    (0, buffer_layout_utils_1.u64)("initPcAmount"),
    (0, buffer_layout_utils_1.u64)("initCoinAmount"),
]);
const MonitorStepArgsLayout = (0, buffer_layout_1.struct)([
    (0, buffer_layout_1.u16)("planOrderLimit"),
    (0, buffer_layout_1.u16)("placeOrderLimit"),
    (0, buffer_layout_1.u16)("cancelOrderLimit"),
]);
const DepositArgsLayout = (0, buffer_layout_1.struct)([
    (0, buffer_layout_utils_1.u64)("maxCoinAmount"),
    (0, buffer_layout_utils_1.u64)("maxPcAmount"),
    (0, buffer_layout_utils_1.u64)("baseSide"),
]);
const WithdrawArgsLayout = (0, buffer_layout_1.struct)([(0, buffer_layout_utils_1.u64)("amount")]);
class Fees {
...
const SwapBaseInArgsLayout = (0, buffer_layout_1.struct)([
    (0, buffer_layout_utils_1.u64)("amountIn"),
    (0, buffer_layout_utils_1.u64)("minimumAmountOut"),
]);
const PreInitializeArgsLayout = (0, buffer_layout_1.struct)([(0, buffer_layout_1.u8)("nonce")]);
const SwapBaseOutArgsLayout = (0, buffer_layout_1.struct)([
    (0, buffer_layout_utils_1.u64)("maxAmountIn"),
...
const AdminCancelOrdersArgsLayout = (0, buffer_layout_1.struct)([
    (0, buffer_layout_1.u16)("limit"),
]);
const UpdateConfigAccountArgsLayout = (0, buffer_layout_1.struct)([
    (0, buffer_layout_1.u8)("param"),
    (0, buffer_layout_utils_1.publicKey)("owner"),
]);
class RaydiumAmmParser {
    static PROGRAM_ID = new web3_js_1.PublicKey("675kPX9MHTjS2zt1qfr1NYHuzeLXfQM9H24wFSUt1Mp8");
    parseInstruction(instruction) {
        const instructionData = instruction.data;
        const instructionType = (0, buffer_layout_1.u8)().decode(instructionData);
    ...
    parseMigrateToOpenBookIx(instruction) {
        ...
        return {
            ...
            args: { unknown: anchor_1.utils.bytes.bs58.encode(instruction.data) },
            programId: instruction.programId,
        };
    }
    parseSetParamsIx(instruction) {
        const accounts = instruction.keys;
        const instructionData = instruction.data;
        const args = (0, borsh_1.deserialize)(SetParamsSchema, SetParamsArgs, instructionData);
        return {
            name: "setParams",
            accounts: accounts.map((account, index) => {
                switch (index) {
            ...
            args: {
                ...
                newPubkey: args?.newPubkey
                    ? anchor_1.utils.bytes.bs58.encode(args.newPubkey)
                    : "",
                fees: args?.fees
                    ? {
    ...
    parseSimulateInfoIx(instruction) {
        const accounts = instruction.keys;
        const instructionData = instruction.data;
        const args = (0, borsh_1.deserialize)(SimulateInfoSchema, SimulateInfoArgs, instructionData);
        return {
            name: "simulateInfo",
            accounts: accounts.map((account, index) => {
                switch (index) {
...
exports.RaydiumAmmParser = RaydiumAmmParser;
//# sourceMappingURL=raydium-amm-parser.js.map